...
print("And then we'll need your Greenhouse Token")
greenhousetoken = getpass.getpass()
...
CandidateInfo = json.loads(apiCandresp.text, strict=False)
Scorecard = json.loads(apiScoreresp.text, strict=False)
